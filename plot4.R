...
plot(df$DateTime,df$Voltage,type="l",ylab="Global Active Power(kw)",xlab='')
...
plot(df$DateTime,df$Global_reactive_power,type="l",ylab="Global Reactive Power",xlab='',col="darkorchid4")
dev.off()